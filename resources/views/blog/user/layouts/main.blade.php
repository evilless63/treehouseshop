            ...
            <div class="menu__column menu__column_desktop">
              <div class="menu__item">
                <div class="search menu__search-item">
                  ...
                  <input type=" text" name="search" placeholder="найти на сайте" autocomplete="off"
  ...
  <div class="page  ">
        ...
        <div class="header__line">
          ...
          <div class="logo ">
            <a href="/" class="logo__link">
              <svg viewbox="0 0 195 28.7" xml:space="preserve" class="logo__image">
          ...
          <div class="header__right-panel">
            ...
            <a href="/cart" class="basket-button">
              <i class="basket-button__icon" data-ga-action="Bag icon click" data-ga-category="Checkout"
                data-ga-label="Пользователь залогинен">
    ...
    <footer class="footer " id="footer">
      <div class="footer__holder">
        <div class="page__row">
          <a class="footer-application" href="https://12stz.onelink.me/BtHu/footer" target="_blank">
            <div class="footer-application__inner">
              <div class="footer-application__logo"></div>
              <div class="footer-application__title">Получите ранний доступ<br /> к новинкам в приложении</div>
              <div class="footer-application__rate">
                <div class="footer-application__stars footer-application__stars--stroke">
                  <div class="footer-application__star"></div>
                  <div class="footer-application__star"></div>
                  <div class="footer-application__star"></div>
                  <div class="footer-application__star"></div>
                  <div class="footer-application__star"></div>
                </div>
                <div class="footer-application__stars footer-application__stars--fill">
                  <div class="footer-application__star footer-application__star--fill"></div>
                  <div class="footer-application__star footer-application__star--fill"></div>
                  <div class="footer-application__star footer-application__star--fill"></div>
                  <div class="footer-application__star footer-application__star--fill"></div>
                  <div class="footer-application__star footer-application__star--fill"></div>
              ...
              <div class="footer-application__button"></div>
            </div>
          </a>
          ...
          <div class="subscribe footer__subscribe media-query-show_mobile">
            ...
            <form class="subscribe-form " action="/subscribe-ajax" method="POST">
              <div class="subscribe-form__settings" data-platform="mobile" data-crm="PodpiskaIzPodvala"
                data-source="footer_mobile"></div>
              <div class="subscribe-form__screen visible" data-name="contacts">
                ...
                <div class="subscribe-form__field">
                  <input class="subscribe-form__input" type="text" name="email" maxlength="255" autocomplete="off"
                ...
                <p class="subscribe-form__privacy">Нажимая на&nbsp;кнопку «Подписаться», я&nbsp;соглашаюсь
                  на&nbsp;обработку моих персональных данных и&nbsp;ознакомлен(а) с&nbsp;<a
                    href="/r/privacy_policy">условиями конфиденциальности</a>.</p>
              </div>
              ...
              <div class="subscribe-form__screen" data-name="subscriptions">
                ...
                <div class="subscribe-form__field subscribe-form__radioset">
                  <div class="subscribe-form__radio">
                    <input class="subscribe-form__radio-input subscribe-form__js-submit" type="radio" name="gender"
                      value="Women" />
            ...
            <nav class="bottom-menu media-query-show-footer_tablet">
              ...
              <div class="footer-col">
                ...
                <div class="footer-col__item footer-col-item" data-slug="about">
                  ...
                  <ul class="footer-col-item__list footer-list">
                    ...
                    <li class="footer-list__item footer-list-item" data-slug="press" data-rank="15">
                      <a class="footer-list-item__link" href="/about/press">
                        Пресса о нас </a>
                    </li>
                  </ul>
                </div>
                ...
                <div class="footer-col__item footer-col-item footer-col-item--connect">
                  ...
                  <ul class="footer-col-item__list footer-list">
                    <li class="footer-list__item footer-list-item">
                      <a class="footer-list-item__link footer-list-item__link-social footer-list-item__link--wa"
                        target="_blank" href="https://api.whatsapp.com/send?phone=79126156257">
                        WhatsApp
                      </a>
                    </li>
                    <li class="footer-list__item footer-list-item">
                    ...
                    <li class="footer-list__item footer-list-item">
                      <a class="footer-list-item__link footer-list-item__link-social footer-list-item__link--telegram"
                        target="_blank" href="tg://resolve?domain=twelvestoreez_bot">
                        Telegram
                      </a>
                    </li>
                  </ul>
              ...
              <div class="footer-col">
                <div class="bottom-menu__item bottom-menu__item_subscribe">
                  ...
                  <form class="subscribe-form " action="/subscribe-ajax" method="POST">
                    <div class="subscribe-form__settings" data-platform="desktop" data-crm="PodpiskaIzPodvala"
                      data-source="footer_desktop"></div>
                    <div class="subscribe-form__screen visible" data-name="contacts">
                      <div class="subscribe-form__title">Узнайте первыми о&nbsp;новинках и&nbsp;скидках</div>
                      <div class="subscribe-form__field">
                        <input class="subscribe-form__input" type="text" name="email" maxlength="255" autocomplete="off"
                    ...
                    <div class="subscribe-form__screen" data-name="subscriptions">
                      ...
                      <div class="subscribe-form__field subscribe-form__radioset">
                        <div class="subscribe-form__radio">
                          <input class="subscribe-form__radio-input subscribe-form__js-submit" type="radio"
            ...
            <div class="footer-line-inn__center footer-socials">
              ...
              <ul class="footer-socials__list footer-socials-list">
                <li class="footer-socials-list__item footer-socials-list-item">
                  <a class="footer-socials-list-item__link footer-socials-list-item__link--youtube "
                    href="https://www.youtube.com/channel/UCUCmIasCXPKOLreAUXZhHtw/" target="_blank" rel="nofollow"></a>
                </li>
                <li class="footer-socials-list__item footer-socials-list-item">
