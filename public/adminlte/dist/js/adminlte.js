...
+function (a) {
    ...
    }, e = {data: '[data-widget="box-refresh"]'}, f = function (b, c) {
    ...
    h.prototype.toggle = function () {
        ...
        var b = a.Event(g.expanded), c = a.Event(g.expanding), d = this.options.collapseIcon,
        ...
        var b = a.Event(g.collapsed), c = a.Event(g.collapsing), d = this.options.collapseIcon,
            h = this.options.expandIcon;
        ...
        var b = a.Event(g.removed), c = a.Event(g.removing);
    ...
    h.prototype.toggle = function (a, b) {
        ...
        c.removeClass(f.open), b.slideUp(this.options.animationSpeed, function () {
            a(this.element).trigger(d), c.find(e.treeview).removeClass(f.open).find(e.treeviewMenu).hide()
        }.bind(this))
    }, h.prototype._setUpListeners = function () {
        var b = this;
    ...
    g.prototype.activate = function () {
        ...
        var b = a(e.mainFooter).outerHeight() || 0, c = a(e.mainHeader).outerHeight() || 0, d = c + b,
            g = a(window).height(), h = a(e.sidebar).height() || 0;
        ...
        this.options.slimscroll && void 0 !== a.fn.slimScroll && 0 === a(e.mainSidebar).find(e.slimScrollDiv).length && a(e.sidebar).slimScroll({height: a(window).height() - a(e.mainHeader).height() + "px"})
    };
    var h = a.fn.layout;
